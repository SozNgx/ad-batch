...
### About ELK degsin, you can read at:
[here](asstets/files/elastic-search.pdf)
# Spring batch job
Follow config on application-dev.yml, change to your config:
![alt](asstets/images/app-dev-config.png)

Run on local with inteliJ please config active profiles = dev. Follow bellow:
![alt](asstets/images/edit-run.png)

![alt](asstets/images/dev-config.png)


After run success, log write at folder: "/var/admage/log/"